...
PRINT 'ESCALATION_SESSION_LOCK_RESULT=' + CAST(@outer_lock_result AS NVARCHAR(12));
...
COMMIT TRANSACTION;
PRINT 'ESCALATION_SESSION_COMMITTED affected_count=' + CAST(@affected_count AS NVARCHAR(12));
GO
